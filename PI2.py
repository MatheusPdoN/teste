...
horario = formag.selectbox(
    'Horário:',
    ('7:40 - 8:30' ,'8:30 - 9:20' ,'9:20 - 10:10','10:20 - 11:10', '11:10 - 12:00','13:00 - 13:50', '13:50 - 14:40', '14:40 - 15:30', '15:40 - 16:30', '16:30 - 17:20')
)
...
if btnregistrar:
    ...
    if len(dados_usuario) == 0:
        ...
        if tiporeg == "Agendamento":
            ...
            cur.execute("INSERT into tbl_agenda (cod_agendamento, sala, nome_usuario, data, horario) values (?,?,?,?,?)", (cod_ag, sala, dados_usuario[0][1], dtagendamento, horario,))
            con.commit()
